...
When its standard input is non-terminal, `secrets edit-human KEY [--source
...
secrets edit-human KEY [--source NAME] [--local]
                                        edits a human-tier key file from a terminal;
                                        otherwise reads stdin and creates or rotates it
